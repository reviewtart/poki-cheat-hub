...
export const games = [
...

  {
    ...
    engine: 'PixiJS + V3D',
    unavailable: 'Poki removed Subway Surfers from their catalog. Snippets remain for archived builds.',
...

  {
    ...
    publisher: 'Madbox',
    engine: 'Custom HTML5',
    unavailable: 'Poki removed this title. Snippets kept for educational use.',
